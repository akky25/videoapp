...
import AnnouncementButton from "~/Components/Button/AnnouncementButton";
            ...
            <form onSubmit={handleAnnouncementSubmit}>
              <div className=" relative mt-2 flex flex-row gap-2">
                ...
                <div className="flex-shrink-0">
                  <button
                    type="submit"
                    className="inline-flex items-center rounded-md bg-primary-600 px-3 py-2 text-sm font-semibold text-gray-100 shadow-sm hover:bg-primary-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600"
                  >
                    Post
                  </button>
                </div>
